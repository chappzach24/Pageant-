...
const ParticipantSchema = new mongoose.Schema(
  {
    ...
    // Modal for past pageant signups which consist of: 
    // headshot, category, biography, title representing, etc

    // Modal for contestant scores, 
    // so we can have a history and contestants can view all past scores
