// client/src/pages/ContestantLogin.jsx
...
const ContestantLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/contestant-dashboard"); // Redirect to contestant dashboard after login
    } catch (error) {
      setErrorMessage(
      ...
      <div className="auth-container u-container" style={{ maxWidth: "480px" }}>
        <div className="auth-card p-4 p-md-5 rounded shadow">
          <div className="auth-header text-center mb-4">
            <h2 className="u-text-dark">Contestant Login</h2>
            <p className="u-text-dark">
              Sign in to access your contestant dashboard
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="d-flex flex-column u-gap-m">
            ...
            <div className="text-center mt-3">
              <p className="u-text-dark mb-0">
                ...
                <Link to="/contestant-signup" className="u-text-brand">
